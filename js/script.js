const global = {
    ...
    api: {
      apiKey: '949ef652be9292cb754513d8766fe58f',
...
async function displayMovieDetails () {
    ...
    const budget = movie.budget ? `$${addCommasToNumber(movie.budget)}` : 'Not available';
    const revenue = movie.revenue ? `$${addCommasToNumber(movie.revenue)}` : 'Not available';
...
function displayPagination() {
  ...
  // Disable nex button if on last page
...
// Init app
function init () {
    // Creating a router for each html page
